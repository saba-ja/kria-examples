...
proc create_root_design { parentCell } {
  ...
  # Create instance: u0_zynq_ps, and set properties
  set u0_zynq_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:zynq_ultra_ps_e:3.5 u0_zynq_ps ]
...
\
  ...
  # Create instance: u1_led_gpio, and set properties
  set u1_led_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 u1_led_gpio ]
  set_property -dict [list \
  ...
  # Create instance: u3_axi_periph_interconnect, and set properties
  set u3_axi_periph_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 u3_axi_periph_interconnect ]
  set_property CONFIG.NUM_MI {1} $u3_axi_periph_interconnect


  # Create instance: u4_zynq_ps_rst, and set properties
  set u4_zynq_ps_rst [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 u4_zynq_ps_rst ]

  # Create interface connections
  connect_bd_intf_net -intf_net u0_zynq_ps_M_AXI_HPM0_FPD [get_bd_intf_pins u0_zynq_ps/M_AXI_HPM0_FPD] [get_bd_intf_pins u3_axi_periph_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net u0_zynq_ps_axi_periph_M00_AXI [get_bd_intf_pins u3_axi_periph_interconnect/M00_AXI] [get_bd_intf_pins u1_led_gpio/S_AXI]

  # Create port connections
  connect_bd_net -net led_o [get_bd_pins u1_led_gpio/gpio_io_o] [get_bd_ports led_o]
  connect_bd_net -net rst_u0_zynq_ps_99M_peripheral_aresetn [get_bd_pins u4_zynq_ps_rst/peripheral_aresetn] [get_bd_pins u3_axi_periph_interconnect/S00_ARESETN] [get_bd_pins u1_led_gpio/s_axi_aresetn] [get_bd_pins u3_axi_periph_interconnect/M00_ARESETN] [get_bd_pins u3_axi_periph_interconnect/ARESETN]
  connect_bd_net -net u0_zynq_ps_pl_clk0 [get_bd_pins u0_zynq_ps/pl_clk0] [get_bd_pins u0_zynq_ps/maxihpm0_fpd_aclk] [get_bd_pins u3_axi_periph_interconnect/S00_ACLK] [get_bd_pins u4_zynq_ps_rst/slowest_sync_clk] [get_bd_pins u1_led_gpio/s_axi_aclk] [get_bd_pins u3_axi_periph_interconnect/M00_ACLK] [get_bd_pins u3_axi_periph_interconnect/ACLK]
  connect_bd_net -net u0_zynq_ps_pl_resetn0 [get_bd_pins u0_zynq_ps/pl_resetn0] [get_bd_pins u4_zynq_ps_rst/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces u0_zynq_ps/Data] [get_bd_addr_segs u1_led_gpio/S_AXI/Reg] -force
